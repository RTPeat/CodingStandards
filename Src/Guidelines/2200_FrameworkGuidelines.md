...
### <a name="ft2201"></a> Use C# type aliases instead of the types from the `System` namespace  (FT2201) ![](images/1.png)
...
### <a name="ft2205"></a> Properly name properties, variables or fields referring to localised resources  (FT2205) ![](images/3.png)
...
### <a name="ft2207"></a> Don't hard-code strings that change based on the deployment  (FT2207) ![](images/3.png)
...
### <a name="ft2210"></a> Build with the highest warning level  (FT2210) ![](images/1.png)
...
### <a name="ft2215"></a> Properly fill the attributes of the `AssemblyInfo.cs` file  (FT2215) ![](images/3.png)
...
### <a name="ft2220"></a> Avoid LINQ for simple expressions  (FT2220) ![](images/3.png)
Rather than:
...
### <a name="ft2221"></a> Use Lambda expressions instead of delegates  (FT2221) ![](images/2.png)
...
### <a name="ft2230"></a> Only use the `dynamic` keyword when talking to a dynamic object  (FT2230) ![](images/1.png)
...
### <a name="ft2235"></a> Favour `async`/`await` over the Task (FT2235) ![](images/1.png)
