...
### <a name="ft1701"></a> Use clear naming (FT1701) ![](images/1.png)

All type members, parameters and variables should be named clearly and in easily understood English.
...
**Exception:** In most projects, you will use words and phrases from our domain and names specific to Fiscal that will be familiar to other developers. Visual Studio's Static Code Analysis performs a spelling check on all code, so you may need to add those terms to a [Custom Code Analysis Dictionary](https://msdn.microsoft.com/en-us/library/bb514188.aspx).

### <a name="ft1702"></a> Use proper casing for language elements (FT1702) ![](images/1.png) 
...
### <a name="ft1704"></a> Don't include numbers in variables, parameters and type members  (FT1704) ![](images/3.png)
In most cases they are a lazy excuse for not defining a clear and intention-revealing name.

### <a name="ft1705"></a> Don't prefix fields  (FT1705) ![](images/1.png)
...
### <a name="ft1706"></a> Don't use abbreviations  (FT1706) ![](images/2.png)
...
### <a name="ft1707"></a> Name a member, parameter or variable according to its meaning and not its type  (FT1707) ![](images/2.png)
...
### <a name="ft1708"></a> Name types using nouns, noun phrases or adjective phrases  (FT1708) ![](images/2.png)
...
Don't include terms like `Utility` or `Helper` in classes. Classes with names like that are usually static classes and are introduced without considering object-oriented principles (see also FT1008).

### <a name="ft1709"></a> Name generic type parameters with descriptive names  (FT1709) ![](images/2.png)
...
### <a name="ft1710"></a> Don't repeat the name of a class or enumeration in its members  (FT1710) ![](images/1.png)
...
### <a name="ft1711"></a> Name members similarly to members of related .NET Framework classes  (FT1711) ![](images/3.png)
...
### <a name="ft1712"></a> Avoid short names or names that can be mistaken for other names  (FT1712) ![](images/1.png)
Although technically correct, statements like the following can be confusing:

	bool b001 = (lo == l0) ? (I1 == 11) : (lOl != 101);

### <a name="ft1715"></a> Properly name properties  (FT1715) ![](images/2.png)
...
### <a name="ft1720"></a> Name methods using a verb or a verb-object pair  (FT1720) ![](images/2.png)
...
Also, don't include `And` in the name of a method. It implies that the method is doing more than one thing, which violates the single responsibility principle explained in FT1115.

### <a name="ft1725"></a> Name namespaces using names, layers, verbs and features  (FT1725) ![](images/3.png)
...
### <a name="ft1735"></a> Use a verb or verb phrase to name an event  (FT1735) ![](images/2.png)
...
### <a name="ft1737"></a> Use `-ing` and `-ed` to express pre-events and post-events  (FT1737) ![](images/3.png)
...
### <a name="ft1738"></a> Prefix an event handler with `On` (FT1738) ![](images/3.png)
...
### <a name="ft1739"></a> Use an underscore for irrelevant lambda parameters (FT1739) ![](images/3.png)
...
### <a name="ft1745"></a> Group extension methods in a class suffixed with Extensions (FT1745) ![](images/3.png)
...
### <a name="ft1755"></a> Post-fix asynchronous methods with `Async` or `TaskAsync` (FT1755) ![](images/2.png)
